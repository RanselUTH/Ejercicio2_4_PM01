...
import com.example.ejercicio2_4_pm01.Clase.datos;
import com.example.ejercicio2_4_pm01.ConectorBD.SQLiteConexion;
import com.example.ejercicio2_4_pm01.transacciones.Transacciones;
...
public class ListadoActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private List<datos> mLista = new ArrayList<>();
    ...
    private void cargarDatos(){
        ...
        while (cursor.moveToNext()){
            ...
            mLista.add(new datos(String.valueOf(id), description, buscarImagen(id)));
            mAdapter = new ListAdapter(this,R.layout.item_row, mLista);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(getApplicationContext(),VizualiarFirmaActivity.class);
